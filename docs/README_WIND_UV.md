...
```bash
cd /path/to/bkk-pm25-data-ingestion
python3 scripts/test_wind_uv_ingestion.py
```
...
1. ✅ Test the new schema with `scripts/test_wind_uv_ingestion.py`
2. ✅ Backfill historical data with `src/past/backfill_weather_with_wind_uv.py`
...
1. Check `docs/WIND_UV_UPDATE.md` for detailed technical documentation
2. Review test script output: `scripts/test_wind_uv_ingestion.py`
