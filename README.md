...
See [docs/ORGANIZATION.md](docs/ORGANIZATION.md) for the full layout and import paths.
...
# Run in order:
# 1. notebooks/exploration/bangkok_environmental_ingestion.ipynb  (data ingestion)
# 2. notebooks/pipelines/preprocessing_pipeline.ipynb           (feature engineering)
# 3. notebooks/exploration/visualization.ipynb                    (EDA # 3. visualization.ipynb                    (EDA & plots) plots)
# 4. notebooks/modeling/model_training.ipynb                   (train + forecast)
